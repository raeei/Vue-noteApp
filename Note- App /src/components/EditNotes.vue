<template>
    ...
    <div class="col-lg-4 col-sm-10 col-sm-8 col-xs-12" style="margin: auto; ">
        <form @submit.prevent="submitUpdateNotes">
            <base-card>
                <template v-slot:default>
                    ...
                    <div class="buttons">
                        <base-button type="submit" :class="buttonControl" :disabled="buttonDisable">Update
                            Note</base-button>
...
export default {
    ...
    watch: {
        ...
        // control button based on the result of the computed buttonControl()
        buttonControl(value) {
            if (value === null) {
    ...
    methods: {
        ...
        loadNote(){
            ...
            this.inputNotes = this.notes[index].notes;
        }
    },
    mounted() {
        this.loadNote();
